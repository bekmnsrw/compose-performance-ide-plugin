...
import compose.performance.ide.plugin.ast.lambda.LambdaAnalyzer
import compose.performance.ide.plugin.ast.stability.StabilityAnalyzer
...
import compose.performance.ide.plugin.utils.Constants.EXPLICIT_GROUPS_COMPOSABLE_FQ_NAME
import compose.performance.ide.plugin.utils.Constants.FUN
import compose.performance.ide.plugin.utils.Constants.NON_RESTARTABLE_COMPOSABLE_FQ_NAME
import compose.performance.ide.plugin.utils.Constants.NON_SKIPPABLE_COMPOSABLE
import compose.performance.ide.plugin.utils.Constants.NON_SKIPPABLE_COMPOSABLE_CAMEL_CASE
import compose.performance.ide.plugin.utils.Constants.NON_SKIPPABLE_COMPOSABLE_ERROR_MESSAGE
import compose.performance.ide.plugin.utils.Constants.NON_SKIPPABLE_COMPOSABLE_FQ_NAME
import compose.performance.ide.plugin.utils.Constants.NON_SKIPPABLE_COMPOSABLE_WARNING_MESSAGE
import compose.performance.ide.plugin.utils.Constants.SUPPRESS
